...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
		<a class="btn btn-primary radius" onclick="window.open('AddType.jsp','_self')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a>
		</span>
		<span class="r">共有数据：<strong>${ShopTypeList.size() }</strong> 条</span>
	</div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<c:forEach items="${ShopTypeList }" var="stl">
					<tr class="text-c">
						<td><input type="checkbox" name="" value=""></td>
						<td>${stl.shoptypeid }</td>
						<td class="text-l">${stl.shoptypename }</td>
