	...
	<div id="body">
		...
		<div id="zhu">
			...
			<table border="0" cellspacing= "0" cellpadding= "0">
				...
				<%
					List<DingDanBiao> list2 = ddbd.ByZhuRenUserGetAllYiWanChengStateInfo(list.get(i).getDingdannumber());
				...
				<tbody>
					<tr >
						...
						<td style="width: 200px;border-bottom:1px #e5e5e5 solid;" align="middle">￥<%=(int)list2.get(k).getSi().getShopprice() * list2.get(k).getDdxq().getCount()%>.0<br/> <span style="color: green;"><%=list2.get(k).getDingdanstate().getStatename() %></span></td>
