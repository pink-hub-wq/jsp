...
@WebServlet(urlPatterns={"/Serach.do"})
public class SerachServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(State == null){
			...
			String Serach = request.getParameter("sousuo");
			...
			if(Serach != null && !Serach.equals("")){
				sis.setShopname(Serach);
			}
			int count = sid.ByShopTypeGetCount(sis);
			...
			request.setAttribute("Serach", Serach);
