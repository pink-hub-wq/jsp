...
@WebServlet(urlPatterns={"/Xie.do"})
public class XieServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(State == null){
			...
			request.getRequestDispatcher("/Xie.jsp").forward(request, response);
