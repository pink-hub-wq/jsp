	...
	public List<ShopInfo> GetAllInfo(ShopInfo si) {
		...
		try {
			...
			while(resultSet.next()){
				ShopInfo si2 = new ShopInfo();
				si2.setChicun(resultSet.getString("si.chicun"));
				si2.setColor(resultSet.getString("si.color"));
				si2.setContext(resultSet.getString("si.context"));
				si2.setCreatetime(resultSet.getString("si.createtime"));
				si2.setImage(resultSet.getString("si.image"));
				si2.setShopid(resultSet.getInt("si.shopid"));
				si2.setShopmiaoshu(resultSet.getString("si.shopmiaoshu"));
				si2.setShopname(resultSet.getString("si.shopname"));
				si2.setShopprice(resultSet.getDouble("si.shopprice"));
				si2.setShoptypeid(resultSet.getInt("si.shoptypeid"));
				si2.setZhuRenUser(resultSet.getString("si.zhurenuser"));
				si2.setXiajia(resultSet.getInt("si.xiajia"));				
				ShopType st = new ShopType();
				st.setShoptypeid(resultSet.getInt("st.shoptypeid"));
				st.setShoptypename(resultSet.getString("st.shoptypename"));
				si2.setShoptype(st);
				list.add(si2);
			}
		} catch (SQLException e) {
