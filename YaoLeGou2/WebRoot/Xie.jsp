    ...
    <div id="div_back">
        <div id="div_ul">
            ...
            <ul  class="daohang" style="float:right">
                ...
                <li onclick="window.open('GouWuChe.do?UserName=${user.userinfo.username}')">购物车</li>
                <li>企业采购</li>
            </ul>
        </div>
        <div id = "DaoHang">
...
<section>
	...
	<form action="Xie.do" method="post">
	    <div id="shaixuan">
	        ...
	        <div class="fenlei" id="ma">
	            <ul>
	                <span style="color:#9EA3A9">品牌选择：</span>
	                <li value="全部品牌">全部品牌</li>
	                <li value="红蜻蜓">红蜻蜓</li>
	                <li value="耐克">耐克</li>
	                <input type="hidden" name="ma" value="${ma==null?'全部品牌':ma }">
	            </ul>
	        </div>
	        <div class="fenlei" style="border-bottom: 0px;" id="banxing">
	            <ul>
	                <span style="color:#9EA3A9">售卖类型：</span>
	                <li value="全部">全部</li>
	                <li value="童瑶自营">童瑶自营</li>
